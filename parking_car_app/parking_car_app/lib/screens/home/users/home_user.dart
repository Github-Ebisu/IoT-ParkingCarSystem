                  ...
                  child: Card(
                    child: Container(
                      ...
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: <Widget>[
                          Text("Biển số xe : ${userData.licensePlate}", style: textStyle16Light.copyWith(fontWeight: FontWeight.w600)),
                          const SizedBox(height: 15),
                          Text("RFID : ${userData.RFID}", style: textStyle16Light.copyWith(fontWeight: FontWeight.w600)),
                          const SizedBox(height: 15),
                          Text("Lần gửi cuối cùng : ${userData.parkingDate}", style: textStyle16Light.copyWith(fontWeight: FontWeight.w600)),
                          const SizedBox(height: 15),
